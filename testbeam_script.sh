...
bin/corry -c ${config} ${files} > ${BASE_PATH}/log/corry_log_run${1}.log
cp ${config} ${BASE_PATH}/conf/conf_run${1}.conf
...
cd plot_scripts
./make_plots.sh ../output/out_MIMOSA.root Run${1} ${BASE_PATH}/plots/
cd ../
